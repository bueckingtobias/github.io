/* ============================================================================
   ...
   ----------------------------------------------------------------------------
   Bequem pflegen: im Dashboard unter „Daten" alles per Formular bearbeiten
   und mit einem Klick eine neue data.js exportieren. Diese Datei dann im
   GitHub-Repo bzw. Google Drive ersetzen. Kein Server nötig.

   Beträge in EUR. Zinssätze als Prozent p.a. (z. B. 3.5). Datum als "YYYY-MM-DD".
   ========================================================================== */

window.DASHBOARD_DATA = {
  meta: { version: "2026-06-01", org: "Bücking Immobilien", updatedAt: "2026-06-01" },

  /* LOGIN — SHA-256 des Passworts. Standard: "baumstrasse". Neu setzen unter „Daten". */
  auth: {
  ...
  projects: [
    {
      ...
      account: { name: "Konto Baumstraße", kontostand: 96000, ruecklagen: 40000 },
      gewerke: [
      ...
      kredite: [
        { id: "baum-kfw",  bezeichnung: "KfW-Darlehen",  glaeubiger: "KfW / Hausbank", art: "annuitaet", rateModus: "tilgungssatz", betrag: 450000, zinsSatz: 2.4, tilgungSatz: 2.0, rateBetrag: 0, laufzeitJahre: 25, start: "2024-04-01", sondertilgungen: [] },
        { id: "baum-bank", bezeichnung: "Bankdarlehen",  glaeubiger: "Sparkasse",      art: "annuitaet", rateModus: "tilgungssatz", betrag: 380000, zinsSatz: 3.6, tilgungSatz: 2.5, rateBetrag: 0, laufzeitJahre: 20, start: "2024-04-01", sondertilgungen: [ { datum: "2025-12-01", betrag: 15000 } ] }
      ],
      cashflow: [
        { monat: "2025-07", miete: 3690, nebenkosten: 740, betriebskosten: 1100, sonstigeKosten: 300 },
        { monat: "2025-08", miete: 3690, nebenkosten: 740, betriebskosten: 1100, sonstigeKosten: 250 },
        { monat: "2025-09", miete: 3690, nebenkosten: 740, betriebskosten: 1200, sonstigeKosten: 400 },
        { monat: "2025-10", miete: 3690, nebenkosten: 740, betriebskosten: 1150, sonstigeKosten: 280 },
        { monat: "2025-11", miete: 3690, nebenkosten: 740, betriebskosten: 1300, sonstigeKosten: 500 },
        { monat: "2025-12", miete: 3690, nebenkosten: 740, betriebskosten: 1400, sonstigeKosten: 900 },
        { monat: "2026-01", miete: 3690, nebenkosten: 740, betriebskosten: 1250, sonstigeKosten: 320 },
        { monat: "2026-02", miete: 3690, nebenkosten: 740, betriebskosten: 1200, sonstigeKosten: 260 },
        { monat: "2026-03", miete: 3690, nebenkosten: 740, betriebskosten: 1280, sonstigeKosten: 350 },
        { monat: "2026-04", miete: 3690, nebenkosten: 740, betriebskosten: 1180, sonstigeKosten: 300 },
        { monat: "2026-05", miete: 3690, nebenkosten: 740, betriebskosten: 1320, sonstigeKosten: 420 },
        { monat: "2026-06", miete: 3690, nebenkosten: 740, betriebskosten: 1240, sonstigeKosten: 280 }
      ]
    },
    {
      id: "huenenberg",
      ...
      investitionStart: "2025-06-01",
      account: { name: "Konto Am Hünenberg", kontostand: 42000, ruecklagen: 15000 },
      gewerke: [
      ...
      weitereInvestition: [
        { titel: "Grundstück",          betrag: 220000 },
        { titel: "Planung / Architekt", betrag: 55000  },
        { titel: "Baunebenkosten",      betrag: 40000  }
      ],
      kredite: [
        { id: "huenen-buecking", bezeichnung: "Annuitätendarlehen E. Bücking", glaeubiger: "E. Bücking", art: "annuitaet", rateModus: "tilgungssatz", betrag: 20000, zinsSatz: 3.5, tilgungSatz: 2.0, rateBetrag: 0, laufzeitJahre: 20, start: "2026-08-01", sondertilgungen: [ { datum: "2027-08-01", betrag: 3000 }, { datum: "2028-08-01", betrag: 3000 }, { datum: "2029-08-01", betrag: 3000 }, { datum: "2030-08-01", betrag: 3000 }, { datum: "2031-08-01", betrag: 3000 } ] }
      ],
      cashflow: [
        { monat: "2026-03", miete: 0,   nebenkosten: 0,   betriebskosten: 400, sonstigeKosten: 200 },
        { monat: "2026-04", miete: 0,   nebenkosten: 0,   betriebskosten: 400, sonstigeKosten: 150 },
        { monat: "2026-05", miete: 850, nebenkosten: 210, betriebskosten: 450, sonstigeKosten: 200 },
        { monat: "2026-06", miete: 850, nebenkosten: 210, betriebskosten: 450, sonstigeKosten: 180 }
      ]
    }
  ],
  ...
  rentals: [
    {
      id: "obj-baumstrasse", projektId: "baumstrasse",
      objekt: "Baumstraße 35", ort: "27777 Ganderkesee",
      einheiten: [
    ...
    {
      id: "obj-huenenberg", projektId: "huenenberg",
      objekt: "Am Hünenberg 12", ort: "27777 Ganderkesee",
      einheiten: [
